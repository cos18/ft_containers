...
void list_basic_test(ft::list<int> &test, std::list<int> &std_list)
{
	...
	ft::list<int>::reverse_iterator cite = test.rend();
	for (ft::list<int>::reverse_iterator cit = test.rbegin(); cit != cite; cit++)
		std::cout << *cit << " ";
	std::cout << std::endl;
	...
	std::cout << "size: " << std_list.size() << std::endl;
	std::cout << "[rvalue]" << std::endl;
	std::list<int>::reverse_iterator std_cite = std_list.rend();
	for (std::list<int>::reverse_iterator std_cit = std_list.rbegin(); std_cit != std_cite; std_cit++)
		std::cout << *std_cit << " ";
	std::cout << std::endl << std::endl;
}
